(()=>{var q={3513:(e,i,d)=>{"use strict";d.r(i),d.d(i,{default:()=>_});var f=d(6758),u=d.n(f),m=d(935),k=d.n(m),C=k()(u());C.push([e.id,`/* Container and Layout */
.Icontainer[data-v-f7b258f0] {
    margin-inline: auto;
    margin-top: 2rem;
    width: 100%;
    min-width: 650px;
...
.vscode-setting-item[data-v-f7b258f0] {
    margin-bottom: 10px;
    padding: 5px 0;
}
.setting-header[data-v-f7b258f0] {
    display: flex;
    align-items: center;
    margin-bottom: 8px;
}
.setting-title[data-v-f7b258f0] {
    font-weight: 600;
    font-size: 14px;
    margin: 0;
}
.setting-body[data-v-f7b258f0] {
    display: flex;
    align-items: flex-start;
    gap: 8px;
}
.setting-description[data-v-f7b258f0] {
    flex: 1;
}
.setting-description info-wrap[data-v-f7b258f0],
.setting-description info[data-v-f7b258f0] {
    display: block;
    margin-bottom: 4px;
}
.setting-description-full[data-v-f7b258f0] {
    margin-bottom: 8px;
}
.setting-description-full info-wrap[data-v-f7b258f0] {
    display: block;
    margin-bottom: 4px;
}
.setting-input-group-full[data-v-f7b258f0] {
    display: flex;
    align-items: center;
    gap: 5px;
}
.setting-input[data-v-f7b258f0] {
    flex-grow: 1;
    margin-right: 2px;
}

/* Form Layout Classes - Base grid layout shared by multiple classes */
.form-row[data-v-f7b258f0],
.form-row-no-align[data-v-f7b258f0] {
    display: grid;
...
.form-double-row[data-v-f7b258f0] {
    display: grid;
...
info[data-v-f7b258f0],
info-wrap[data-v-f7b258f0] {
...
/* Form Elements */
span[data-v-f7b258f0],
select[data-v-f7b258f0] {
    display: block;
}
textarea[data-v-f7b258f0] {
...
/* Button Styles */
.button-theme-primary[data-v-f7b258f0],
.button-theme-inline[data-v-f7b258f0] {
...
.button-theme-primary[data-v-f7b258f0]:hover:not(:disabled) {
...
.button-theme-inline[data-v-f7b258f0]:hover:not(:disabled) {
    background: var(--vscode-button-secondaryHoverBackground);
    cursor: pointer;
}
button[data-v-f7b258f0]:disabled {
    opacity: 0.5;
    cursor: not-allowed;
}

/* Payload Section Styles */
.payload-button-group[data-v-f7b258f0] {
    display: flex;
    gap: 5px;
    margin-bottom: 10px;
}
.payload-textarea[data-v-f7b258f0] {
    width: 100%;
    min-height: 200px;
...
/* Collapsible Section */
.collapsible-section[data-v-f7b258f0] {
    margin: 15px 0;
    border: 1px solid var(--vscode-widget-border);
    border-radius: 4px;
}
.collapsible-header[data-v-f7b258f0],
.collapsible-content[data-v-f7b258f0] {
    max-width: 96%;
}
.collapsible-header[data-v-f7b258f0] {
    padding: 8px 12px;
...
.remote-debug-checkbox[data-v-f7b258f0] {
...
.remote-debug-checkbox[data-v-f7b258f0]:checked {
    background-color: var(--vscode-checkbox-selectBackground) !important;
    border-color: var(--vscode-checkbox-selectBorder) !important;
}
.remote-debug-checkbox[data-v-f7b258f0]:disabled {
    opacity: 0.6;
    cursor: not-allowed;
    border-color: var(--vscode-checkbox-border) !important;
    background-color: var(--vscode-input-background) !important;
}
.remote-debug-checkbox[data-v-f7b258f0]:focus {
    outline: 2px solid var(--vscode-focusBorder);
    outline-offset: 2px;
}
`,""]);const _=C},935:e=>{"use strict";e.exports=function(i){var d=[];return d.toString=function(){return this.map(function(u){var m="",k=typeof u[5]<"u";return u[4]&&(m+="@supports (".concat(u[4],") {")),u[2]&&(m+="@media ".concat(u[2]," {")),k&&(m+="@layer".concat(u[5].length>0?" ".concat(u[5]):""," {")),m+=i(u),k&&(m+="}"),u[2]&&(m+="}"),u[4]&&(m+="}"),m}).join("")},d.i=function(u,m,k,C,_){typeof u=="string"&&(u=[[null,u,void 0]]);var x={};if(k)for(var P=0;P<this.length;P++){var B=this[P][0];B!=null&&(x[B]=!0)}for(var R=0;R<u.length;R++){var p=[].concat(u[R]);k&&x[p[0]]||(typeof _<"u"&&(typeof p[5]>"u"||(p[1]="@layer".concat(p[5].length>0?" ".concat(p[5]):""," {").concat(p[1],"}")),p[5]=_),m&&(p[2]&&(p[1]="@media ".concat(p[2]," {").concat(p[1],"}")),p[2]=m),C&&(p[4]?(p[1]="@supports (".concat(p[4],") {").concat(p[1],"}"),p[4]=C):p[4]="".concat(C)),d.push(p))}},d}},6758:e=>{"use strict";e.exports=function(i){return i[1]}},7433:(e,i)=>{"use strict";var d;d={value:!0},i.A=(f,u)=>{const m=f.__vccOpts||f;for(const[k,C]of u)m[k]=C;return m}},8317:(e,i,d)=>{var f=d(3513);f.__esModule&&(f=f.default),typeof f=="string"&&(f=[[e.id,f,""]]),f.locals&&(e.exports=f.locals);var u=d(611).A,m=u("6c106b4a",f,!1,{})},611:(e,i,d)=>{"use strict";d.d(i,{A:()=>J});function f(n,c){for(var l=[],s={},r=0;r<c.length;r++){var D=c[r],v=D[0],L=D[1],S=D[2],F=D[3],E={id:n+":"+r,css:L,media:S,sourceMap:F};s[v]?s[v].parts.push(E):l.push(s[v]={id:v,parts:[E]})}return l}var u=typeof document<"u";if(typeof DEBUG<"u"&&DEBUG&&!u)throw new Error("vue-style-loader cannot be used in a non-browser environment. Use { target: 'node' } in your Webpack config to indicate a server-rendering environment.");var m={},k=u&&(document.head||document.getElementsByTagName("head")[0]),C=null,_=0,x=!1,P=function(){},B=null,R="data-vue-ssr-id",p=typeof navigator<"u"&&/msie [6-9]\b/.test(navigator.userAgent.toLowerCase());function J(n,c,l,s){x=l,B=s||{};var r=f(n,c);return O(r),function(v){for(var L=[],S=0;S<r.length;S++){var F=r[S],E=m[F.id];E.refs--,L.push(E)}v?(r=f(n,v),O(r)):r=[];for(var S=0;S<L.length;S++){var E=L[S];if(E.refs===0){for(var M=0;M<E.parts.length;M++)E.parts[M]();delete m[E.id]}}}}function O(n){for(var c=0;c<n.length;c++){var l=n[c],s=m[l.id];if(s){s.refs++;for(var r=0;r<s.parts.length;r++)s.parts[r](l.parts[r]);for(;r<l.parts.length;r++)s.parts.push($(l.parts[r]));s.parts.length>l.parts.length&&(s.parts.length=l.parts.length)}else{for(var D=[],r=0;r<l.parts.length;r++)D.push($(l.parts[r]));m[l.id]={id:l.id,refs:1,parts:D}}}}function I(){var n=document.createElement("style");return n.type="text/css",k.appendChild(n),n}function $(n){var c,l,s=document.querySelector("style["+R+'~="'+n.id+'"]');if(s){if(x)return P;s.parentNode.removeChild(s)}if(p){var r=_++;s=C||(C=I()),c=U.bind(null,s,r,!1),l=U.bind(null,s,r,!0)}else s=I(),c=K.bind(null,s),l=function(){s.parentNode.removeChild(s)};return c(n),function(v){if(v){if(v.css===n.css&&v.media===n.media&&v.sourceMap===n.sourceMap)return;c(n=v)}else l()}}var W=function(){var n=[];return function(c,l){return n[c]=l,n.filter(Boolean).join(`
